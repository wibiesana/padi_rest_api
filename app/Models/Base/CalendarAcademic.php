...
class CalendarAcademic extends ActiveRecord
{
    protected string $table = 'calendar_academics';
    protected string|array $primaryKey = 'id';
    
    protected array $fillable = [
        'title', 'description', 'start_date', 'end_date', 'color', 'is_holiday', 'status'
    ];
    ...
    public function searchPaginate(string $keyword, int $page = 1, int $perPage = 25, ?string $orderBy = null): array
    {
        ...
        $query = Query::find()
            ...
            ->where(['OR',
                ['LIKE', 'calendar_academics.title', $keyword],
                ['LIKE', 'calendar_academics.description', $keyword],
                ['LIKE', 'calendar_academics.status', $keyword]
            ]);
    ...
    /**
     * Search calendar_academics (simple limit)
     */
